...
.sp-gr-admin-wrap.sp-gr-builder-page{width:auto;max-width:none}.sp-gr-tabs{display:inline-flex;gap:4px;margin:0 0 20px;padding:4px;border:0;border-radius:0;background:var(--sp-admin-surface-subtle,#e9edf3)}.sp-gr-tabs .nav-tab{margin:0;padding:7px 14px;border:0;border-radius:0;background:transparent;color:var(--sp-admin-text-2,#4b5563);font-size:13px;font-weight:600;line-height:20px}.sp-gr-tabs .nav-tab:hover{background:color-mix(in srgb,var(--sp-admin-surface,#fff) 60%,transparent);color:var(--sp-admin-text,#1d2327)}.sp-gr-tabs .nav-tab-active{background:var(--sp-admin-surface,#fff);color:var(--sp-admin-accent,#2746c7);box-shadow:var(--sp-admin-shadow-xs,0 1px 3px rgb(16 24 40 / 12%))}.sp-gr-builder-intro{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:18px 20px}.sp-gr-builder-intro h2{margin:0 0 4px;font-size:18px}.sp-gr-builder-intro p{margin:0;color:var(--sp-admin-muted,#646970)}.sp-gr-builder-count{padding:7px 11px;border-radius:var(--sp-admin-radius-pill,0);background:var(--sp-admin-accent-soft,#eef2ff);color:var(--sp-admin-accent,#2746c7);white-space:nowrap}

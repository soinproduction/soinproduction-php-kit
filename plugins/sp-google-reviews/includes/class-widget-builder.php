					...
					<section class="sp-gr-control-section">
						...
						<div class="sp-gr-control-grid sp-gr-control-grid--interaction">
							...
							<div class="sp-gr-link-options">
								<label class="sp-favorite-settings-row"><input type="checkbox" name="<?php echo esc_attr( $name ); ?>[link_target]" value="blank" data-setting="link_target" <?php checked( $widget['link_target'], 'blank' ); ?>><span>Open in a new tab</span></label>
								<label class="sp-favorite-settings-row"><input type="checkbox" name="<?php echo esc_attr( $name ); ?>[link_nofollow]" value="1" data-setting="link_nofollow" <?php checked( ! empty( $widget['link_nofollow'] ) ); ?>><span>Add nofollow</span></label>
							</div>
						</div>
					</section>
...
.sp-gr-admin-wrap.sp-gr-builder-page{width:auto;max-width:none}.sp-gr-tabs{display:flex;width:100%;min-height:54px;margin:0 0 20px;padding:0;border:1px solid var(--sp-admin-border,#e7eaee);border-radius:0;background:var(--sp-admin-surface,#fff);box-sizing:border-box;box-shadow:var(--sp-admin-shadow-xs,0 1px 2px rgb(16 24 40 / 5%))}.sp-gr-tabs .nav-tab{position:relative;display:inline-flex;align-items:center;gap:8px;margin:0;padding:15px 20px;border:0;border-right:1px solid var(--sp-admin-border,#e7eaee);border-radius:0;background:transparent;color:var(--sp-admin-text-2,#4b5563);font-size:13px;font-weight:650;line-height:22px;transition:background var(--sp-admin-transition,.16s),color var(--sp-admin-transition,.16s)}.sp-gr-tabs .nav-tab .dashicons{width:18px;height:18px;font-size:18px;line-height:18px}.sp-gr-tabs .nav-tab:hover{background:var(--sp-admin-surface-alt,#f8fafc);color:var(--sp-admin-accent-hover,#2145e6)}.sp-gr-tabs .nav-tab:focus-visible{z-index:1;box-shadow:inset 0 0 0 2px var(--sp-admin-accent,#3858e9);outline:0}.sp-gr-tabs .nav-tab-active,.sp-gr-tabs .nav-tab-active:hover{background:var(--sp-admin-accent-soft,#edf0ff);color:var(--sp-admin-accent,#3858e9);box-shadow:inset 0 -3px 0 var(--sp-admin-accent,#3858e9)}.sp-gr-tabs .nav-tab-active .dashicons{color:var(--sp-admin-accent,#3858e9)}.sp-gr-builder-intro{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:18px 20px}.sp-gr-builder-intro h2{margin:0 0 4px;font-size:18px}.sp-gr-builder-intro p{margin:0;color:var(--sp-admin-muted,#646970)}.sp-gr-builder-count{padding:7px 11px;border-radius:var(--sp-admin-radius-pill,0);background:var(--sp-admin-accent-soft,#eef2ff);color:var(--sp-admin-accent,#2746c7);white-space:nowrap}
...
@media(max-width:1180px){.sp-gr-widget-editor__body{grid-template-columns:1fr}.sp-gr-widget-editor__preview{border-top:1px solid var(--sp-admin-border,#e7eaee);border-left:0}.sp-gr-preview-stage{position:static;min-height:220px}}@media(max-width:782px){.sp-gr-control-grid,.sp-gr-control-grid--compact,.sp-gr-component-list,.sp-gr-color-grid,.sp-gr-asset-grid,.sp-gr-link-options{grid-template-columns:1fr}.sp-gr-link-options{padding-top:0}.sp-gr-widget-editor__header{align-items:flex-start;flex-direction:column}.sp-gr-widget-editor__actions{width:100%}.sp-gr-builder-intro{align-items:flex-start;flex-direction:column}.sp-gr-tabs{display:flex}.sp-gr-tabs .nav-tab{flex:1;text-align:center}}
CSS;
	}

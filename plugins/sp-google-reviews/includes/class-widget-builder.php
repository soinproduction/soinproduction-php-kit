					...
					<section class="sp-gr-control-section">
						...
						<div class="sp-gr-control-grid sp-gr-control-grid--interaction">
							...
							<div class="sp-gr-link-options">
								<label class="sp-switch-row"><span><strong>Open in a new tab</strong></span><input type="checkbox" name="<?php echo esc_attr( $name ); ?>[link_target]" value="blank" data-setting="link_target" <?php checked( $widget['link_target'], 'blank' ); ?>><i aria-hidden="true"></i></label>
								<label class="sp-switch-row"><span><strong>Add nofollow</strong></span><input type="checkbox" name="<?php echo esc_attr( $name ); ?>[link_nofollow]" value="1" data-setting="link_nofollow" <?php checked( ! empty( $widget['link_nofollow'] ) ); ?>><i aria-hidden="true"></i></label>
							</div>
						</div>
					</section>

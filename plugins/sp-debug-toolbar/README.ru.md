...
В `DEV_MODE` верхняя панель WordPress показывает защищённую ссылку установки или активации официального **Query Monitor**, если он ещё не активен. После активации PHP Kit убирает свою ссылку, потому что Query Monitor добавляет собственную панель.

...
final class SP_Font_Family_Select_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'font_family_select';
    ...
    {
        if (! isset($_GET['sp_font_family_select_js']) || '1' !== (string) $_GET['sp_font_family_select_js']) {
            return;
        }
...
SP_Font_Family_Select_Plugin::init();

...
final class SP_Aosanimate_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'aosanimate';
    ...
    {
        if (! isset($_GET['sp_aos_for_editor_js']) || '1' !== (string) $_GET['sp_aos_for_editor_js']) {
            return;
        }

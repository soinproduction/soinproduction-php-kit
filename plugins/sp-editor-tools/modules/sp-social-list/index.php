...
final class SP_Social_List_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'social_list';
    ...
    {
        if (! isset($_GET['sp_social_list_js']) || '1' !== (string) $_GET['sp_social_list_js']) {
            return;
        }

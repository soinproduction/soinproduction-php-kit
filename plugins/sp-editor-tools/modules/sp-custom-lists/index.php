...
final class SP_Custom_Lists_Plugin
{
    private const VERSION = '1.1.0';
    private const BUTTON  = 'custom_lists';
    ...
    {
        if (! isset($_GET['sp_custom_lists_js']) || '1' !== (string) $_GET['sp_custom_lists_js']) {
            return;
        }

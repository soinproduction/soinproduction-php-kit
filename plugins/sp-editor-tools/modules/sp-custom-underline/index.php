...
final class SP_Underline_Toggle_Elem_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'underline_toggle_elem';
    ...
    {
        if (! isset($_GET['sp_custom_underline_js']) || '1' !== (string) $_GET['sp_custom_underline_js']) {
            return;
        }
...
SP_Underline_Toggle_Elem_Plugin::init();

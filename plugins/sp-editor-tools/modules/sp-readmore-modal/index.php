...
final class SP_Read_More_Modal_Img_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'sp_read_more_modal_img';
    ...
    {
        if (! isset($_GET['sp_readmore_modal_js']) || '1' !== (string) $_GET['sp_readmore_modal_js']) {
            return;
        }
...
SP_Read_More_Modal_Img_Plugin::init();

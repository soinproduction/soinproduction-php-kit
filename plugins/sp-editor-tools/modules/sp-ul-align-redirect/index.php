...
final class SP_Ul_Align_Redirect_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'ul_align_redirect';
    ...
    {
        if (! isset($_GET['sp_ul_align_redirect_js']) || '1' !== (string) $_GET['sp_ul_align_redirect_js']) {
            return;
        }
...
SP_Ul_Align_Redirect_Plugin::init();

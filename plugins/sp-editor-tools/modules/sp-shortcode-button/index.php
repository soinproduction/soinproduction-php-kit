...
final class SP_Shortcode_Button_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'shortcode_button';
    ...
    {
        if (! isset($_GET['sp_shortcode_button_js']) || '1' !== (string) $_GET['sp_shortcode_button_js']) {
            return;
        }
...
SP_Shortcode_Button_Plugin::init();

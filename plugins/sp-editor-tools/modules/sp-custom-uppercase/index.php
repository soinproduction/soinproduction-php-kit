...
final class SP_Textcase_Elem_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'textcase_elem';
    ...
    {
        if (! isset($_GET['sp_custom_uppercase_js']) || '1' !== (string) $_GET['sp_custom_uppercase_js']) {
            return;
        }

...
final class SP_Small_Toggle_Plugin
{
    private const VERSION = '1.0.0';
    private const BUTTON  = 'small_toggle';
    ...
    {
        if (! isset($_GET['sp_small_button_tag_js']) || '1' !== (string) $_GET['sp_small_button_tag_js']) {
            return;
        }

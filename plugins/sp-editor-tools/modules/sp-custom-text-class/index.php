...
final class SP_Tag_Style_Selector_Plugin
{
    private const VERSION = '1.1.0';
    private const BUTTON  = 'tag_style_selector';
    ...
    {
        if (! isset($_GET['sp_custom_text_class_js']) || '1' !== (string) $_GET['sp_custom_text_class_js']) {
            return;
        }
...
SP_Tag_Style_Selector_Plugin::init();

<?php
	...
	final class SP_Editor_Row_Plugin
	{
		private const VERSION = '1.0.0';
		private const BUTTON  = 'sp_editor_row';
		...
		{
			if (! isset($_GET['sp_editor_row_js']) || '1' !== (string) $_GET['sp_editor_row_js']) {
				return;
			}

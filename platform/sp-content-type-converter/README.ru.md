...
Добавляет одиночные и bulk admin actions для переноса контента между post types с совместимым конструктором. Подключается именем `sp-content-type-converter`.

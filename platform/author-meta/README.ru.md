...
Добавляет переиспользуемый metabox автора для выбранных post types. Подключите platform-модуль `author-meta`, затем явно зарегистрируйте нужные типы записей.
